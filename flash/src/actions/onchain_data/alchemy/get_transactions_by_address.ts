...
import { TransactionsByAddressSchema, TRANSACTIONS_BY_ADDRESS_PROMPT, GET_TRANSACTIONS_BY_ADDRESS_ACTION_NAME } from "../../../actions_schemas/onchain_data/alchemy/get_transactions_by_address";
...
export class GetTransactionsByAddressAction implements ZapAction<typeof TransactionsByAddressSchema> {
  public name = GET_TRANSACTIONS_BY_ADDRESS_ACTION_NAME;
