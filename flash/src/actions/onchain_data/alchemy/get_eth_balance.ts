...
import { EthBalanceSchema, ETH_BALANCE_PROMPT, GET_ETH_BALANCE_ACTION_NAME } from "../../../actions_schemas/onchain_data/alchemy/get_eth_balance";
...
export class GetEthBalanceAction implements ZapAction<typeof EthBalanceSchema> {
  public name = GET_ETH_BALANCE_ACTION_NAME;
