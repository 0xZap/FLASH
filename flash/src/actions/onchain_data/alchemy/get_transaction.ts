...
import { TransactionInfoSchema, TRANSACTION_INFO_PROMPT, GET_TRANSACTION_ACTION_NAME } from "../../../actions_schemas/onchain_data/alchemy/get_transaction";
...
export class GetTransactionAction implements ZapAction<typeof TransactionInfoSchema> {
  public name = GET_TRANSACTION_ACTION_NAME;
