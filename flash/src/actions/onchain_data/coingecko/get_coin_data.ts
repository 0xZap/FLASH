...
import { CoinDataSchema, COIN_DATA_PROMPT, GET_COIN_DATA_ACTION_NAME } from "../../../actions_schemas/onchain_data/coingecko/get_coin_data";
/**
...
export class GetCoinDataAction implements ZapAction<typeof CoinDataSchema> {
  public name = GET_COIN_DATA_ACTION_NAME;
