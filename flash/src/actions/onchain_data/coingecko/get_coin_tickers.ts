...
import { CoinTickersSchema, COIN_TICKERS_PROMPT, GET_COIN_TICKERS_ACTION_NAME } from "../../../actions_schemas/onchain_data/coingecko/get_coin_tickers";
...
export class GetCoinTickersAction implements ZapAction<typeof CoinTickersSchema> {
  public name = GET_COIN_TICKERS_ACTION_NAME;
