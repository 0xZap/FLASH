...
import { CoinChartSchema, GET_COIN_CHART_ACTION_NAME, COIN_CHART_PROMPT } from "../../../actions_schemas/onchain_data/coingecko/get_coin_chart";
...
export class GetCoinChartAction implements ZapAction<typeof CoinChartSchema> {
  public name = GET_COIN_CHART_ACTION_NAME;
